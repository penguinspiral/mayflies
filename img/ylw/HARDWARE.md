...
$ sudo inxi --expanded
System:
  Host: ylw Kernel: 6.12.63+deb13-amd64 arch: x86_64 bits: 64
...
Graphics:
  ...
  Display: server: No display server data found. Headless machine? tty: 107x62
...
Network:
  ...
  IF: wlp89s0 state: down mac: 14:ea:63:5c:08:fb
  IF-ID-1: thunderbolt0 state: down mac: 02:7d:4c:30:7a:4b
  IF-ID-2: thunderbolt1 state: down mac: 02:25:2c:9f:44:d8
...
Drives:
  Local Storage: total: 1.03 TiB used: 3.1 MiB (0.0%)
...
Info:
  Memory: total: 96 GiB available: 94.04 GiB used: 2.17 GiB (2.3%) igpu: 60 MiB
  Processes: 255 Uptime: 23d 16h 46m Init: systemd Shell: Sudo inxi: 3.3.38
```
