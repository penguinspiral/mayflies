...
A "target" is a targetable (via repo-level Makefile), [live-image](https://salsa.debian.org/live-team/live-images/-/tree/upstream/images/standard?ref_type=heads) adherent
...
Debian GNU/Linux's official `live-images` documentation ([ref](https://live-team.pages.debian.net/live-manual/html/live-manual/index.en.html))
...
TL;DR configuration layout: [ref](https://github.com/nodiscc/debian-live-config/blob/master/doc/md/custom.md#changing-the-default-build-configuration)
